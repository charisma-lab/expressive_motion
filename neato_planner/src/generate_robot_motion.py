...
class PurePursuit:
    def __init__(self):
        rospy.init_node('expressive_motion_node')
        ...
        rospy.Subscriber('velocity_factor', Float64, self.vel_factor_cb, queue_size=1)
    ...
    def vel_factor_cb(self, val):
        self.VELOCITY_FACTOR = val.data
